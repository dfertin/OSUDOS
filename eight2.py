...
image1 = pygame.image.load(r"C:\Users\aiz\OneDrive\Desktop\osudos\sticker (85).webp")
image2 = pygame.image.load(r"C:\Users\aiz\OneDrive\Desktop\osudos\sticker (86).webp")
...
DB_LANGUAGE_NAME = "Python"  # язык программирования, для которого берем вопросы
